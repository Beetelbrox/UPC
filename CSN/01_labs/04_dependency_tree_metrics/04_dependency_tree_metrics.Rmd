...
One of the assumptions of non-linear regression is homoscedasticity, so before generating our models we need to make sure it holds.
...
## On correctness
Before applying our methods to the real data 
